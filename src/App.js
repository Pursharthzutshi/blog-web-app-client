...
function App() {
  ...
  const logOut = ()=>{
    axios.get(`https://blog-web-app-server-rho.vercel.app/logout`).then((response)=>{
...
const showBlogContent = (individualBlogPostId) =>{
  ...
  axios.get(`https://blog-web-app-server-rho.vercel.app/fetch/${individualBlogPostId}`).then((res)=>{
